...
const updateProject = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const project = yield project_model_1.default.findByIdAndUpdate(id, data, { new: true });
    return project;
});
...
exports.projectServices = { createProject, getAllProjects, updateProject, deleteProject };
